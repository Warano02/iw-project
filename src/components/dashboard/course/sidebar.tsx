...
export function CourseSidebar({
    ...
    const navItems = [
      { icon: BookAIcon, label: "Course", href: `/teacher/${idCourse}` },
      { icon: BookCopy, label: "Exam", href: `/teacher/${idCourse}/exam` },
      { icon: Mail, label: "Inbox", href: `/teacher/${idCourse}/inbox` },
      { icon: BookOpenCheck, label: "Assigment", href: `/teacher/${idCourse}/assigment` },
      { icon: Bell, label: "Notifications", href: `/teacher/${idCourse}/notifications` },
      { icon: Trash2, label: "Trash", href: `/teacher/${idCourse}/trash` },
      { icon: Settings, label: "Settings", href: `/teacher/${idCourse}/settings` },
    ];
  const isHomePage = pathname === "/teacher";
