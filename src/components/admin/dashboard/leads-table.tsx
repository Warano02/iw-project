        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex-1 sm:flex-none">
            ...
            <Input
              ...
              className="pl-9 h-9 w-full sm:w-45"
            />
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                ...
                <TableHead className="min-w-40">Lead Name</TableHead>
                <TableHead className="min-w-45 hidden md:table-cell">
                  Email
                </TableHead>
                <TableHead className="w-27.5">Status</TableHead>
                <TableHead className="w-25 hidden lg:table-cell">
                  Source
                </TableHead>
                <TableHead className="w-35 hidden xl:table-cell">
                  Owner
                </TableHead>
                <TableHead className="w-32.5">Created On</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
