...
export function LeadsByStatusChart() {
  ...
  return (
    <div className="bg-card text-card-foreground rounded-xl border w-full xl:w-84.25 shrink-0">
        ...
        <div className="space-y-3 sm:space-y-4">
          {filteredAndSortedData.map((item) => (
            <div key={item.name} className="flex items-center gap-3 sm:gap-4">
              <span className="text-xs text-muted-foreground w-16 sm:w-15.5 shrink-0 truncate">
                {item.name}
              </span>
              <div className="flex-1 h-3.75 bg-muted rounded">
                <div
              ...
              <span className="text-xs font-semibold w-10 sm:w-7.5 text-right shrink-0">
